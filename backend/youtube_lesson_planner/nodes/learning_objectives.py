...
prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            - If it's complex, generate a short list of up to 3 learning objectives suitable for an all-digital asynchronous learning platform. Each objective should be:
